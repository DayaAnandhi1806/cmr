    ...
    columns = [
        {
            ...
            {
               "label": "<div style='text-align: center; line-height: 1.5;'><span style='color: red; font-weight: bold;'>Meeting Target (FTD)</span></div>",
            ...
            {
                "label": "<div style='text-align: center; line-height: 1.5;'><span style='color: red; font-weight: bold;'>Personal Meetings (FTD)</span></div>",
                
                # "label": "<span style='color: red; font-weight: bold; background-color: yellow;'>Meeting Target</span>",
            ...
            {
                "label": "<div style='text-align: center; line-height: 1.5;'><span style='color: red; font-weight: bold;'>Client/Partner Event (FTD)</span></div>",
            ...
            {
                "label": "<div style='text-align: center; line-height: 1.5;'><span style='color: red; font-weight: bold;'>Total Meetings as per Weightage (FTD)</span></div>",
            ...
            {
                "label": "<div style='text-align: center; line-height: 1.5;'><span style='color: green; font-weight: bold;'>Meeting Target (MTD)</span></div>",
            ...
            {
                "label": "<div style='text-align: center; line-height: 1.5;'><span style='color: green; font-weight: bold;'>Personal Meetings (MTD)</span></div>",
                # "label": "Personal Meetings",
                "fieldtype": "Int",
            ...
            {
                "label": "<div style='text-align: center; line-height: 1.5;'><span style='color: green; font-weight: bold;'>Client/Partner Event (MTD)</span></div>",
                # "label": "Client/Partner Event",
                "fieldtype": "Int",
            ...
            {
                "label": "<div style='text-align: center; line-height: 1.5;'><span style='display: inline-block; color: green; font-weight: bold;'>Total Meetings as per Weightage (MTD)</span></div>",
